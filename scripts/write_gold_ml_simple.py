"""Write ML results to Gold schema tables - simplified, no retraining."""
import sys
...
spark = get_spark("Write Gold ML Simple")
...
spark.sql(f"CREATE TABLE {ns}.gold.model_predictions (id_mahasiswa STRING, angkatan INT, prediksi STRING, probability DOUBLE)")
batch_size = 3000
...
# 3. model_metrics_final (hardcoded from pipeline output)
print("3. model_metrics_final")
...
('GaussianNB_8_features_with_smote','final_8_features_smote',
 0.6664,0.0122, 0.9471,None, 0.6324,None, 0.7467,0.0110,
...
# 4. confusion_matrix_final
print("4. confusion_matrix_final")
...
# 5. classification_report_final
print("5. classification_report_final")
