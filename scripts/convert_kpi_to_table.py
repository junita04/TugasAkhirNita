"""
CONVERT 8 KPI: big_number_total -> table (card display).
Table is the most stable native viz. Single metric = card.
"""
...
print("Converting 8 KPI to table cards...")
...
for cid, defn in kpi_defs.items():
    ...
    print(f"  ID={cid:3d} {defn['name']:35s} -> table")
