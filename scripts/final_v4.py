...
# Show IPK distribution data
print(f"\n{'='*95}")
print("IPK DISTRIBUTION DATA (Chart 100)")
print(f"{'='*95}")
r100 = s.get(f"{BASE}/api/v1/chart/100")
c100 = r100.json()["result"]
qc100 = json.loads(c100["query_context"])
