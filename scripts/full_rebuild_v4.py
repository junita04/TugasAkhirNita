"""
COMPLETE DASHBOARD REBUILD: 8 sections
"""
...
# Section 1: Ringkasan Akademik (3+3+2+2+2=12)
add_section(1, "Ringkasan Akademik", [
    [66, 67, 68, 69, 70],
])

# Section 2: Profil Mahasiswa
# Row 1: Bar Angkatan (12w)
# Row 2: 2 Donuts (6+6)
...
# Section 4: Status Kelulusan Aktual
# Single pie chart, full width
add_section(4, "Status Kelulusan Aktual", [
    [78],
])
...
# Row 1: Aktif per Semester (4w) + IPK Aktif (4w) + Selisih SKS (4w)
...
# Row 1: CM (6w) + CR (6w)
add_section(7, "Confusion Matrix", [
    [85, 86],
])

# Section 8: Hasil Evaluasi Model Machine Learning (3+3+3+3=12)
add_section(8, "Hasil Evaluasi Model Machine Learning", [
    [81, 82, 83, 84],
])
