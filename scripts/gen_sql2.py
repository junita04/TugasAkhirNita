...
with open("D:/TA/TugasAkhirNita/scripts/update_qc_21_25.sql", "w") as f:
    f.write("BEGIN;\n")
    f.write(sql21 + "\n")
    f.write(sql25 + "\n")
    f.write("COMMIT;\n")
